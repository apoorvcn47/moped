"""autogenerated by genpy from pr_msgs/herbActionResult.msg. Do not edit."""
import sys
...
class herbActionResult(genpy.Message):
  ...
  _type = "pr_msgs/herbActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_msgs/herbResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pr_msgs.msg.herbResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr_msgs.msg.herbResult()
